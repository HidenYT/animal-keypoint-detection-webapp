...
LABELED_VIDEO_UPLOAD_DIR = "labeled_videos"
...
LABELED_VIDEOS_DIR_PATH = INFERENCE_RESULTS_DIR_PATH / LABELED_VIDEO_UPLOAD_DIR
...
SLEAP_MICROSERVICE_URL = os.getenv("SLEAP_MICROSERVICE_URL")
